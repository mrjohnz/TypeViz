...
interface Array {
    ...
    Any(f?, thisRef?): boolean;
    Pretty(length?: number): string;
    Take(from: number, to?: number): any[];
    ...
    All(f, thisArg?: any): boolean;
    Pop(): any;
    HasProperty(key: string): boolean;
    IndexOf(obj): number;
    Fold(f, acc?, thisRef?): any;
    Reduce(f, acc?, thisRef?): any;
    Map(f, thisRef?): any[];
    First(f?, thisRef?): any;
    Insert(element, position: number): any[];
    Append(...x): any[];
    Prepend(...x): any[];
    IsEmpty(): boolean;
    Clear(): any[];
    BiSort(a: any[], b: any[], f?): void;
    /*Returns the interval of the array.*/
    Extent(f?): any[];
    Reverse(): any[];
    Initialize(what, amount: number): any[];
...
if (Array.prototype.Add == null) {
    Array.prototype.Add = function (...items) {
        if (TypeViz.IsUndefined(items)) throw "Cannot add undefined element to the array";
...
if (Array.prototype.HasProperty == null) {
    Array.prototype.HasProperty = function (property: string) {
...
if (Array.prototype.All == null) {
    if (Array.prototype.every != null) {
        ...
        Array.prototype.All = function (iterator, context?) {
            if (TypeViz.IsUndefined(iterator)) throw "The iterator is not defined.";
            var result = true;
...
if (Array.prototype.Flatten == null) {
    ...
    Array.prototype.Flatten = function (shallow = true) {
...
if (!Array.prototype.Prepend) {
     ...
     */
    Array.prototype.Prepend = function (...items:any []) {
        if (TypeViz.IsUndefined(items)) throw "Cannot prepend undefined element to the array";
        for (var i = 0; i < items.length; i++) {
...
if (Array.prototype.Take == null) {
    ...
    Array.prototype["Take"] = function (fromOrAmount: number, to: number = null) {
        if (fromOrAmount < 0) throw "The first parameter cannot be less than zero.";
        if (to == null) {
            if (fromOrAmount == 0) return [];
            return this.slice(0, fromOrAmount);
        }
        else {
            if (to < fromOrAmount) throw "The second parameter cannot be less than the first one.";
...
if (Array.prototype.Pretty == null) {
    Array.prototype["Pretty"] = function (length = 10) {
...
if (Array.prototype.Flatten == null) {
    Array.prototype.Flatten = function () {
        var merged = [];
        return <any[]>merged.concat.apply(merged, <any[]>this);
    };
}
;
...
if (Array.prototype.Distinct == null) {
    Array.prototype.Distinct = function () {
        ...
        return <any[]> <any>r; // bug in TypeScript really
    };
}
;
...
if (Array.prototype.Min == null) {
    Array.prototype.Min = function (f?) {
        var i = -1,
            ...
            b;
        if (f == null) {
            while (++i < n && !((a = this[i]) != null && a <= a)) a = undefined;
            while (++i < n) if ((b = this[i]) != null && a > b) a = b;
        } else {
            while (++i < n && !((a = f.call(this, this[i], i)) != null && a <= a)) a = undefined;
            while (++i < n) if ((b = f.call(this, this[i], i)) != null && a > b) a = b;
        }
        return a;
    };
}
...
if (Array.prototype.Max == null) {
    Array.prototype.Max = function (f?) {
        ...
        if (f == null) {
            while (++i < n && !((a = this[i]) != null && a <= a)) a = undefined;
            while (++i < n) if ((b = this[i]) != null && b > a) a = b;
        } else {
            while (++i < n && !((a = f.call(this, this[i], i)) != null && a <= a)) a = undefined;
            while (++i < n) if ((b = f.call(this, this[i], i)) != null && b > a) a = b;
        }
        return a;
    };
}
...
if (Array.prototype.Sum == null) {
    Array.prototype.Sum = function (f?) {
        ...
        if (f == null) {
            while (++i < n) if (!isNaN(a = +this[i])) s += a;
        } else {
            while (++i < n) if (!isNaN(a = +f.call(this, this[i], i))) s += a;
        }
...
if (Array.prototype.Extent == null) {
    ...
    Array.prototype.Extent = function (f?) {
        ...
        if (TypeViz.IsUndefined(f)) {
            while (++i < n && !((a = c = this[i]) != null && a <= a)) a = c = undefined;
            while (++i < n) if ((b = this[i]) != null) {
                if (a > b) a = b;
                if (c < b) c = b;
            }
        } else {
            while (++i < n && !((a = c = f.call(this, this[i], i)) != null && a <= a)) a = undefined;
            while (++i < n) if ((b = f.call(this, this[i], i)) != null) {
                if (a > b) a = b;
                if (c < b) c = b;
            }
        }

...
module UnitTests {
    ...
    test("Add Canvas", function () {
        ...
        var found = document.getElementById('SVGRoot');
        var svg = <SVGSVGElement><Object>found;
    ...
    test("Add/Remove/Clear Marker", function () {
        ...
        AddCircle(canvas, new Point(100, 120));
    ...
    test("Predefined", function () {
        ...
        for (var i = 0; i < someColors.length; i++) {
            ...
            var known: Color = Colors[someColors[i]];
    ...
    test("Cursor", function () {
        ...
        circ.Id = "MyCirc";
        circ.Position = new Point(200, 200);
        circ.Cursor = TypeViz.SVG.Cursors.Wait;
        canvas.Append(circ);
        equal(circ.Cursor, TypeViz.SVG.Cursors.Wait);
    });
    ...
    test("Color", function () {
        ...
        var hsl:TypeViz.Media.HSL = rgb.AsHSL;
        equal(hsl.L, 1);
        equal(hsl.S, 0);
        equal(hsl.H, 0);

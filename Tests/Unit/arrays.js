...
(function (UnitTests) {
    ...
    test("Extent", function () {
        ...
        var exx = objs.Extent(function (d) {
            return d.age;
        });
        deepEqual(exx, [6, 66]);
    });
    ...
    test("Fold", function () {
        var sum = [2, 3, 2].Fold(function (memo, num) {
            return memo + num;
        }, 0);
        equal(sum, 7);
    ...
    test("Map", function () {
        var sum = [2, "e", 3, 5, -5].Map(function (x) {
            return 1;
        }).Sum();
        equal(sum, 5);
        var mapped = [1, 2, 3].Map(function (x) {
            return x * x;
        });

...
interface QUnit {
    testSkip(title: string, test: (assert?: QUnitAssert) => any): void;
}
module UnitTests {
    ...
    function testSkip(name: string, test: (assert?: QUnitAssert) => any) {
    ...
    testSkip('Eight graph layout', function () {
        var g = Predefined.EightGraph();//.Grid(2, 2);
    ...
    testSkip('Random diagram layout', function () {
        ...
        var settings = new TypeViz.Diagramming.LayoutSettings();
        settings.Type = TypeViz.Diagramming.LayoutTypes.TreeLayout;
        settings.SubType = TypeViz.Diagramming.TreeLayoutType.TreeRight;
        diagram.Layout(settings);
        ok(true);
    });
    ...
    testSkip('Mindmap layout', function () {
        ...
        var settings = new TypeViz.Diagramming.LayoutSettings();
        settings.Type = TypeViz.Diagramming.LayoutTypes.TreeLayout;
        settings.SubType = TypeViz.Diagramming.TreeLayoutType.MindmapVertical;
        settings.Roots = [root];
        diagram.Layout(settings);
        diagram.Zoom = 0.5;
        ok(true);
    ...
    testSkip('Tip-over tree layout', function () {
        ...
        var settings = new TypeViz.Diagramming.LayoutSettings();
        settings.Type = TypeViz.Diagramming.LayoutTypes.TreeLayout;
        settings.SubType = TypeViz.Diagramming.TreeLayoutType.TipOverTree;
        settings.Roots = [root];
    ...
    testSkip('Varying shape size layout', function () {
        ...
        var settings = new TypeViz.Diagramming.LayoutSettings();
        settings.Type = TypeViz.Diagramming.LayoutTypes.TreeLayout;
        settings.SubType = TypeViz.Diagramming.TreeLayoutType.TreeUp;
        diagram.Layout(settings);
        //diagram.zoom(0.5);
        ok(true);
    });
    ...
    testSkip('Layered layout', function () {
        ...
        settings.SubType = TypeViz.Diagramming.LayeredLayoutType.Right;
